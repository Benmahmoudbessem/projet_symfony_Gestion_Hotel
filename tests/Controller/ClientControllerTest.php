...
final class ClientControllerTest extends WebTestCase
{
    ...
    public function testShow(): void
    {
        ...
        $fixture->setContactNumber('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $fixture->setContactNumber('Value');
        ...
        $this->client->submitForm('Update', [
            ...
            'client[contactNumber]' => 'Something New',
        ...
        self::assertSame('Something New', $fixture[0]->getContactNumber());
